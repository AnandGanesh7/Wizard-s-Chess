...
public class Aboutus extends Activity implements TextToSpeech.OnInitListener 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		ivscreen5=(ImageView) findViewById(R.id.imageViewscreen5);
		...
		ivscreen5.setOnLongClickListener(new OnLongClickListener() {
